...
---
Four datasets are included for test, which are obtained from [Stanford Network Analysis Project](http://snap.stanford.edu/index.html), covering networks that scale from thousands of nodes to millions of nodes.
